...
```
#### Exportamos los hashes a un archivo para su correspondiente crackeo:

```bash
┌──(root㉿kali)-[/home/…/OffSec/Challenges/2_Relia/245-machine]
└─# unshadow /root/.msf4/loot/20250609154137_relia_192.168.180.245_linux.passwd_700690.txt \
         /root/.msf4/loot/20250609154138_relia_192.168.180.245_linux.shadow_517407.txt \
         > hashes.txt
```
#### Crackeamos con john:
```bash
