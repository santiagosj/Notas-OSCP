...
> ⚠️ Importante: usa la extensión .pHp, respetando mayúsculas y minúsculas.
...
User accounts for \\LEGACY ------------------------------------------------------------------------------- Administrator adrian damon DefaultAccount Guest WDAGUtilityAccount The command completed successfully.
...
6de2be6545730d15382906e9f34e3db8
```
