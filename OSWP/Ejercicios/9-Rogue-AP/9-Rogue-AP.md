...
2. Use hostapd-mana para iniciar el punto de acceso y capturar un protocolo de enlace (handshake) de un cliente que ya estaba conectado al punto de acceso de destino.
